...
urlpatterns = [
    ...
    path('products/create/category/<int:pk>/', adminapp.product_create_view, name='product_create'),
    path('products/read/category/<int:pk>/', adminapp.products_view, name='products'),
    path('products/read/<int:pk>/', adminapp.product_read_view, name='product_read'),
    path('products/update/<int:pk>/', adminapp.product_update_view, name='product_update'),
    path('products/delete/<int:pk>/', adminapp.product_delete_view, name='product_delete'),
]
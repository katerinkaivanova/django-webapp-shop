...
SOCIAL_AUTH_VK_OAUTH2_KEY = config.getint('OAUTH2', 'SOCIAL_AUTH_VK_OAUTH2_KEY')
...
# This backend is not intended for use in production – it can be used during development
